 ...
 */
    ...
    {
        return $this->render('ressources/indexUser.html.twig', [
    ...
    {
        return $this->render('ressources/showRessourcesUser.html.twig', [
            'ressource' => $ressource,
        ]);
    }
    ...
    public function pdf(Ressources $ressource) : Response
    {
        ...
        $html = $this->renderView('ressources/pdf.html.twig', [
            'ressource' => $ressource,
        ]);
        // Load HTML to Dompdf
    ...
    {
        return $this->render('ressources/pdf.html.twig', [
            'ressource' => $ressource,
        ]);
    }
